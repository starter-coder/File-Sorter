...
class SortingGUI:
    ...
    def create_left_frame(self):
        ...
        left_frame = Frame(self.window, bg="gray25", width=150, height=300).grid(row=0, column=0)
        left_label = Label(left_frame, text="Welcome to File-Sorter app\n\n"
                                            "This program lets you sort\n"
                                            "files into:\n"
                                            "\u2022 Music\n"
                                            "\u2022 Videos\n"
                                            "\u2022 Documents\n"
                                            ...
                                            "  source folder", justify=LEFT, bg="gray25", fg="white")
